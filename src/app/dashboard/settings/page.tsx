                ...
                <div className="bg-[#BCE3BC]/20 rounded-xl p-8 border border-[#BCE3BC] flex flex-col md:flex-row items-center justify-between gap-6">
                  <div className="max-w-lg">
                    ...
                    <p className="text-slate-600 mt-2 text-sm">
                      Upgrade to Creator to remove Sellen branding, get 0% transaction fees, and unlock unlimited products.
                    </p>
                  </div>
                  <button className="whitespace-nowrap px-8 py-3 bg-[#2D5A27] text-white font-bold rounded-full hover:bg-[#3d7a35] transition-all text-sm">
                  ...
                  <div className="max-w-md space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-[#BCE3BC] focus:border-transparent outline-none transition-all text-sm"
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center border border-slate-200 rounded-lg overflow-hidden">
                        ...
                        <input
                          ...
                          className="flex-1 px-3 py-2 bg-slate-50 outline-none text-sm"
                        />
                      </div>
                    </div>
                    <div className="pt-2">
                      <button
                        onClick={handleSave}
                        className="px-6 py-2 bg-[#2D5A27] text-white font-bold rounded-lg text-sm hover:bg-[#3d7a35] transition-colors"
                      >
            ...
            <div className="space-y-6">
              <div className="bg-white border border-slate-200 rounded-xl p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="px-6 py-3 bg-[#2D5A27] text-white rounded-xl font-bold text-sm hover:bg-[#3d7a35] transition-colors">
                    Upgrade to Creator — $19/mo
                  </button>
                </div>
              </div>
