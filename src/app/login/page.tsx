    ...
    <div className="min-h-screen bg-[#f0f7f0] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#1c1917]/60 text-sm mt-2">Welcome back</p>
        </div>

        {/* Card */}
        <div className="bg-white rounded-2xl shadow-sm border border-[#2c493e]/10 p-8">
          <h1 className="text-2xl font-bold text-[#1c1917] mb-6">Log in to your account</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-xs text-[#2c493e] hover:underline">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#1c1917]/60">
              ...
              <Link href="/signup" className="text-[#2c493e] font-bold hover:underline">
                Sign up free
              </Link>
            </p>
          </div>
        ...
        <p className="text-center text-xs text-[#1c1917]/40 mt-6">
          Sell anything. Keep everything. · sellen.store
        </p>
      </div>
    </div>
  );
